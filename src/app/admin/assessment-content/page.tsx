...
export default async function AssessmentContentPage() {
  ...
  const sections: { type: AssessmentType; title: string; questions: typeof healthCheckQuestions | typeof readyToRentQuestions }[] = [{ type: "health_check", title: "Property Health Check", questions: healthCheckQuestions }, { type: "ready_to_rent", title: "Ready to Rent", questions: readyToRentQuestions }];

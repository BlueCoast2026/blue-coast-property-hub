...
import { ClipboardCheck, Clock3, Send, ArrowLeft, ArrowRight, UsersRound, FileUp, Newspaper, ListChecks } from "lucide-react";
import { requireStaff } from "@/lib/auth/permissions";
import { PotentialSellerLeads } from "@/components/admin/potential-seller-leads";
...
export default async function AdminPage() {
  ...
  return <main className="min-h-screen bg-mist px-5 py-10 sm:px-8 lg:px-12"><div className="mx-auto max-w-7xl">
    ...
    {role === "admin" && <Link href="/admin/assessment-content" className="mt-6 inline-flex h-11 items-center gap-2 rounded-xl border border-line bg-white px-5 text-sm font-semibold text-navy"><ListChecks className="size-4" />Assessment content CMS</Link>}
    ...
    {role === "admin" && <PotentialSellerLeads />}

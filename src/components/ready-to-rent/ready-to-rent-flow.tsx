...
export function ReadyToRentFlow({ properties, initialPropertyId, questions, language }: { properties: Property[]; initialPropertyId?: string; questions: DisplayQuestion[]; language: AppLanguage }) {

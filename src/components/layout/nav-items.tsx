import { Home, ClipboardCheck, KeyRound, ChartNoAxesCombined, Wrench, Library, Scale } from "lucide-react";
...
export function getNavGroups(language: "en" | "zh") {
  ...
  const labels = [["物业中心", ["您的物业", "物业健康检查", "出租准备检查", "物业决策检查"]], ["市场与资讯", ["市场洞察", "工具", "资源"]]] as const;

...
export function SuburbReportForm() {
  ...
  return <form action={action} className="mt-6 grid gap-5 sm:grid-cols-2">
    <label className="text-sm font-medium text-ink">Market<select required name="market" className="mt-2 h-12 w-full rounded-xl border border-line bg-white px-4 outline-none focus:border-coastal"><option value="gold_coast">Gold Coast</option><option value="brisbane">Brisbane</option></select></label>
    ...
    <label className="text-sm font-medium text-ink">Area<select required name="zone" className="mt-2 h-12 w-full rounded-xl border border-line bg-white px-4 outline-none focus:border-coastal"><optgroup label="Gold Coast"><option value="Coastal">Coastal</option><option value="Central">Central</option><option value="Northern">Northern</option><option value="Hinterland">Hinterland</option></optgroup><optgroup label="Brisbane"><option value="Brisbane City">Brisbane City</option><option value="Logan">Logan</option><option value="Ipswich">Ipswich</option><option value="South Brisbane">South Brisbane</option></optgroup></select></label>
